        ...
        <div class="row pt-4">
            <div class="col-lg-6">
                ...
                <form action="check.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="special_instructions">Special Cooking Instructions:(optional)</label>
                        <textarea placeholder="Eg. Add more vegetables
       Add more nuts" class="form-control" id="special_instructions" name="special_instructions" rows="3"
                    ...
                    <h5>Order Summary</h5>
                        ...
                        <tbody>
                            ...
                            foreach ($_SESSION['cart_items'] as $key => $value) {
                                ...
                                <td><img src='./uploads/" . $value['img'] . "' alt='product image' class='img-flui' width='80' height='80' style='object-fit:cover;'></td>
                            </tr>";
                            }
                            // display total
                            echo "<tr>
            ...
            <script>
                var options = {
                    ...
                    "handler": function (response) {
                        ...
                        // Add the special instructions to the form
                        var input_special_instructions = document.createElement("input");
                        input_special_instructions.type = "hidden";
                        input_special_instructions.name = "special_instructions";
                        input_special_instructions.value = document.getElementById("special_instructions").value;
                        form.appendChild(input_special_instructions);
